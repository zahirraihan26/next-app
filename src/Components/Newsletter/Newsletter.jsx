            ...
            <div className="max-w-4xl mx-auto px-4 text-center">
                ...
                <form className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <input
                        ...
                        className="w-full sm:w-96 px-6 py-3 rounded-full text-zinc-900 focus:outline-none focus:ring-2 focus:ring-blue-300"
                        required
                    />
                    <button
                        type="submit"
                        className="w-full sm:w-auto px-8 py-3 bg-zinc-900 text-white font-semibold rounded-full hover:bg-zinc-800 transition shadow-lg"
                    >
                        Subscribe
                    </button>
                </form>
